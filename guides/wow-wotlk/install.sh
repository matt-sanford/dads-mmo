...
create_accounts() {
    ...
    echo ""
    echo -e "${WHITE}Account creation requires an interactive terminal${NC}"
    echo -e "${WHITE}which works best as a separate step.${NC}"
    echo ""
    echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${WHITE}${BOLD} Run this now to create your accounts:${NC}"
    echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    echo -e "  ${GREEN}chmod +x create-accounts.sh && ./create-accounts.sh${NC}"
    echo ""
    echo -e "${WHITE}Or create manually via the GM console:${NC}"
    echo ""
    ...
    echo -e "  ${GREEN}account create admin admin admin${NC}"
    echo -e "  ${GREEN}account set gmlevel admin 3 -1${NC}"
    echo -e "  ${YELLOW}(exit: Ctrl+P then Ctrl+Q)${NC}"
    echo ""
    echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    echo -e "${WHITE}Press ENTER when you have created at least one account...${NC}"
    read -r
}
